...
LINK void        rcs_drawPixmap(rcs_Display* d,rcs_Window,rcs_GC,int,int,const char**);
LINK void        rcs_drawSubPixmap(rcs_Display* d,rcs_Window,rcs_GC,int,int,const char**,int,int,int,int);
LINK void        rcs_drawPoint(rcs_Display*,rcs_Window win,rcs_GC gc,
                                 int x,int y);
LINK void        rcs_drawString(rcs_Display*,rcs_Window,rcs_GC,int,int,const char*);
...
LINK void        rcs_namedBackground(rcs_Display*,rcs_GC gc,const char* color);
LINK void        rcs_namedForeground(rcs_Display*,rcs_GC gc,const char* color);
LINK rcs_Display *rcs_openDisplay(const char* display_name);
LINK rcs_Font    rcs_openFont(rcs_Display*,const char*);
...
LINK rcs_Pixmap  rcs_xpmToPixmap(rcs_Display* d,rcs_Window,const char** data);
...
class rcs_CComponent : public rcs_CObject {
  ...
  public:
    ...
    LINK virtual void setName(char* name);
...
class rcs_CImageButton : public rcs_CButton {
  ...
  public:
    ...
    LINK virtual void setImage(char** img);
    LINK virtual void paintUp();
    LINK virtual void paintDown();
    LINK virtual void paint(rcs_CEvent* e);
  };
...
class rcs_CPostScript : public rcs_CObject {
  protected:
    ...
    virtual void    addItem(char* name,PSDATA data);
    virtual void    addToDict(char* name,PSDATA data,PSDATA* dict);
    virtual void    outputData(PSDATA data);
    virtual PSDATA  searchDictionary(PSDATA* dict,char* cmd);
...
LINK    void setSide(char);
LINK    int getTileRank(int value);
  };
...
LINK void rcsgl_drawString(IMAGE* image,int x,int y,char* str,
                          byte r,byte g,byte b);
...
/* log.c */
LINK void rcsgl_log(char* buffer);
LINK void enableLog();
LINK void disableLog();
LINK void log_enter(char* buffer);
LINK void log_exit(char* buffer);
LINK void log_indent();
LINK void log_outdent();
LINK void setLogfile(char* name);
LINK void writeLog(char* buffer);
LINK void log_noindent(char* buffer);
